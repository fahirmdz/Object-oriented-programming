...
void main()
{
	...
	// 5. NAZIVI FUNKCIJA MORAJU BITI IDENTIENI ONIMA KOJI SU KORITENI U TESTNOM CODE-U.OSTALE, POMOANE FUNKCIJE
	// MOETE IMENOVATI PO ELJI. TAKO?ER, MOETE DODAVATI KOLIKO ELITE TESTNIH PODATAKA
	****************************************************************************/
	try {
